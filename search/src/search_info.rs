...
use crate::{clear_stop, emit_stop, query_stop};

use crate::traits::{AlphaBetaSearchFunctionality, Move};
use crate::alpha_beta_search::alpha_beta_search;
...
impl<Board> Default for UciInfo<Board> {
    fn default() -> Self {
        Self{
...
impl<Board: Send + AlphaBetaSearchFunctionality + 'static> UciInfo<Board> {
